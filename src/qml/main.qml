...
Rectangle
{
    ...
    ScrollView
    {
        ...
        /*Text {
         * Layout.columnSpan: 2
         * text: root.name+((root.device != "")?" ["+root.device+"]":"")
         * //font.pointSize: 13
    }*/
        ...
        {
            Layout.alignment: Qt.AlignLeft | Qt.AlignVCenter
            width: Math.max(scrollView_.viewport.width, implicitWidth + 2 * spacing)
            //´height: Math.max(scrollView_.viewport.height, implicitHeight + 2 * spacing)
            anchors.margins: 10
            Layout.fillHeight: true
            Layout.fillWidth: true
            GroupBox
